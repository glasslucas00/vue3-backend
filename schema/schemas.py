...
class MeasSearchTable(BaseModel):
    ...
    meastypes: Union[str, List] = None
    stagger: Union[str, List] = None  # 拉出值
    height: Union[str, List] = None  # 导高
    temperature_max: Union[str, List] = None  # 最高温度
    abrasion: Union[str, List] = None  # 磨耗
...
class AbnormSearchTable(BaseModel):
    ...
    metro_name: str
    timestamp: List = None
    id_station_next: Union[int,str] = None
    id_station_pre: Union[int,str] = None
    direction: List = None
